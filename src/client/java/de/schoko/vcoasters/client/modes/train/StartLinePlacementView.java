...
public class StartLinePlacementView extends View<TrainEditorMode> {
	private Vector3f a;
	private Vector3f b;

	public StartLinePlacementView(TrainEditorMode mode) {
		super(mode);
	}
	...
	public void render(RenderContext renderContext) {
		...
		Vec3 off = direction.cross(new Vec3(0, 1, 0)).normalize().scale(getMode().getBeamSpacing() * 0.5);
