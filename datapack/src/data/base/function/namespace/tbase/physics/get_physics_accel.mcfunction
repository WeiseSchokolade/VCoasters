...
execute if data storage train:storage tbase.line{physics_type:"BRAKE"} if score #train_vel train_math_score matches 1001.. run return run function base:namespace/current/physics/round_brake_accel
